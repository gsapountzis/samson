...
public interface JForm<T> {
    ...
    /**
     * Configuration: disable bean validation
     */
    static final boolean CONF_DISABLE_VALIDATION = false;

    /**
     * Configuration: maximum list size
     * <p>
     ...
     * than 4GB of memory.
     */
    static final int CONF_MAX_LIST_SIZE = 256;
